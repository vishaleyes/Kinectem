...
public function profile_get_settings() {
	...
	$oReturn->settings->emlActivityMentions = true;
	$oReturn->settings->emlActivityReply = true;
	$oReturn->settings->emlMemberSend = true;
	$oReturn->settings->emlGroupInvite = true;
	$oReturn->settings->emlGroupUpdate = true;
	$oReturn->settings->emlGroupPromoted = true;
	$oReturn->settings->emlJoinYourGroup = true;
	$oReturn->settings->emlForumPostNotification = true;
	$oReturn->settings->emlFollowActivity = true;
	$oReturn->settings->send_requests = true;
	$oReturn->settings->accept_requests = true;
...
public function bbp_api_new_topic_handler() {
  ...
  return $oReturn;
	...
	*/
    ...
    function activity_preview_video () { print_r($_POST);die;
        if($_POST['data']){
...
//'<a href=\"http://52.35.93.122/kinectem/members/\">jack</a> changed their profile picture. <br /><img src=\"http://52.35.93.122/kinectem/wp-content/uploads/avatars/72/3bc542520d57470ac10480dad6931b99-bpthumb.jpg\" alt=\"\" />changed their profile picture.';
		...
		//echo "USER ID : ".print_r($favData);die;
		//echo "<br/>";
		$total_comment_count = 0;
