...
//echo $recieverdata['driverID'];
 ...
 function updateDeviceToken()
 {
     $oReturn = new stdClass();
     if(!$_REQUEST['user_id']){$oReturn->error = __('user_id is required.','aheadzen'); return $oReturn;}
     if(!$_REQUEST['device_type']){$oReturn->error = __('device_type is required.','aheadzen'); return $oReturn;}
     if(!$_REQUEST['device_token']){$oReturn->error = __('device_token is required.','aheadzen'); return $oReturn;}
