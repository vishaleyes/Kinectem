...
/* ----- Duration methods ----- */
	...
	/**
	 * Pack Duration info, and return it.
	 * Duration type agnostic.
	 * @return string Duration
	 */
	public function get_duration () {
		if ($this->_duration) return $this->_duration;
		$this->_duration = get_post_meta($this->get_id(), 'incsub_event_duration', true);
...
/* ----- Notes methods ----- */
	...
	/**
	 * Pack Notes info, and return it.
	 * Notes type agnostic.
	 * @return string Notes
	 */
	public function get_notes () {
		if ($this->_notes) return $this->_notes;
		$this->_notes = get_post_meta($this->get_id(), 'incsub_event_notes', true);
		return $this->_notes;
	}
...
/* ----- Reoccurance methods ----- */
	...
	/**
	 * Pack Reoccurance info, and return it.
	 * Notes type agnostic.
	 * @return string Reoccurance
	 */
	public function get_reoccurance () {
		if ($this->_reoccurance) return $this->_reoccurance;
		$this->_reoccurance = get_post_meta($this->get_id(), 'incsub_event_reoccurance', true);
		return $this->_reoccurance;
	}

/* ----- Opponent methods ----- */

	/**
	 * Pack Opponent info, and return it.
	 * Notes type agnostic.
	 * @return string Opponent
	 */
	public function get_opponent () {
		if ($this->_opponent) return $this->_opponent;
		$this->_opponent = get_post_meta($this->get_id(), 'incsub_event_opponentF', true);
