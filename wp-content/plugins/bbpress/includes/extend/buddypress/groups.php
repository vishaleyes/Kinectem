...
class BBP_Forums_Group_Extension extends BP_Group_Extension {
	...
	public function edit_screen( $group = false ) {
		...
		<h4><?php esc_html_e( 'Team Forum Settings', 'bbpress' ); ?></h4>

		<fieldset>
			<legend class="screen-reader-text"><?php esc_html_e( 'Team Forum Settings', 'bbpress' ); ?></legend>
			<p><?php esc_html_e( 'Create a discussion forum to allow members of this team to communicate in a structured, bulletin-board style fashion.', 'bbpress' ); ?></p>

			<div class="field-group">
				<div class="checkbox">
					<label><input type="checkbox" name="bbp-edit-group-forum" id="bbp-edit-group-forum" value="1"<?php checked( $checked ); ?> /> <?php esc_html_e( 'Yes. I want this team to have a forum.', 'bbpress' ); ?></label>
				</div>
			...
			<?php if ( bbp_is_user_keymaster() ) : ?>
				<div class="field-group">
					<label for="bbp_group_forum_id"><?php esc_html_e( 'Team Forum:', 'bbpress' ); ?></label>
					<?php
						bbp_dropdown( array(
					...
					?>
					<p class="description"><?php esc_html_e( 'Network administrators can reconfigure which forum belongs to this team.', 'bbpress' ); ?></p>
				</div>
			<?php endif; ?>
	...
	public function create_screen( $group_id = 0 ) {
		...
		<h4><?php esc_html_e( 'Team Forum', 'bbpress' ); ?></h4>

		<p><?php esc_html_e( 'Create a discussion forum to allow members of this team to communicate in a structured, bulletin-board style fashion.', 'bbpress' ); ?></p>

		<div class="checkbox">
			<label><input type="checkbox" name="bbp-create-group-forum" id="bbp-create-group-forum" value="1"<?php checked( $checked ); ?> /> <?php esc_html_e( 'Yes. I want this team to have a forum.', 'bbpress' ); ?></label>			
		</div>
				...
				case 'page' :
					...
					// No forums found
						...
						<div id="message" class="info">
							<p><?php esc_html_e( 'This team does not currently have a forum.', 'bbpress' ); ?></p>
						</div>
