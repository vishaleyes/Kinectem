...
class BP_Groups_Group {
	...
	public function populate() {
		...
		$this->location_state  = stripslashes( $group->location_state );
		$this->location_city  = stripslashes( $group->location_city );
		$this->sport  = stripslashes( $group->sport );
	...
	public function save() {
		...
		$bp = buddypress();
		$this->location_state  =  $_POST['group-location-state'];
		$this->location_city  =  $_POST['group-location-city'];
		$this->sport  =  $_POST['group-sports'];
		...
		$this->location_state  = apply_filters( 'groups_group_location_state_before_save', $this->location_state, $this->id );
		$this->location_city  = apply_filters( 'groups_group_location_city_before_save', $this->location_city, $this->id );
		$this->sport  = apply_filters( 'groups_group_sports_before_save', $this->sport, $this->id );
