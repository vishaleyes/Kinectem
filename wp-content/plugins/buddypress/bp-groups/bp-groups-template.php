...
/**
 * Output the location state of the current group in the loop.
 *
 * @param object|bool $group Optional. Group object.
 *                           Default: current group in loop.
 */
function bp_group_location_state( $group = false ) {
	echo bp_get_group_location_state( $group );
}
	/**
	 * Get the location state of the current group in the loop.
	 *
	 * @param object|bool $group Optional. Group object.
	 *                           Default: current group in loop.
	 *
	 * @return string
	 */
	function bp_get_group_location_state( $group = false ) {
		global $groups_template;
		...
		/**
		 * Filters the location state of the current group in the loop.
		 *
		 * @since 1.0.0
		 *
		 * @param string $name Name of the current group in the loop.
		 */
		return apply_filters( 'bp_get_group_location_state', $group->location_state );
	}

/**
 * Output the location city of the current group in the loop.
 *
 * @param object|bool $group Optional. Group object.
 *                           Default: current group in loop.
 */
function bp_group_location_city( $group = false ) {
	echo bp_get_group_location_city( $group );
}
	/**
	 * Get the location city of the current group in the loop.
	 *
	 * @param object|bool $group Optional. Group object.
	 *                           Default: current group in loop.
	 *
	 * @return string
	 */
	function bp_get_group_location_city( $group = false ) {
		global $groups_template;
		...
		/**
		 * Filters the location city of the current group in the loop.
		 *
		 * @since 1.0.0
		 *
		 * @param string $name Name of the current group in the loop.
		 */
		return apply_filters( 'bp_get_group_location_city', $group->location_city );
	}

function bp_group_sport( $group = false ) {
	echo bp_get_group_sport( $group );
}
	/**
	 * Get the location city of the current group in the loop.
	 *
	 ...
	 * @return string
	 */
	function bp_get_group_sport( $group = false ) {
		global $groups_template;
		 ...
		 * @param string $name Name of the current group in the loop.
		 */
		return apply_filters( 'bp_get_group_sport', $group->sport );
	}
...
function bp_new_group_location_state() {
	echo bp_get_new_group_location_state();
}
	function bp_get_new_group_location_state() {
		$bp   = buddypress();
		$location_state = isset( $bp->groups->current_group->location_state )
			? $bp->groups->current_group->location_state
			: '';
		 ...
		 * @param string $name Name of the new group.
		 */
		return apply_filters( 'bp_get_new_group_location_state', $location_state );
	}
function bp_new_group_location_city() {
	echo bp_get_new_group_location_city();
}
	function bp_get_new_group_location_city() {
		$bp   = buddypress();
		$location_city = isset( $bp->groups->current_group->location_city )
			? $bp->groups->current_group->location_city
			: '';
		 ...
		 * @param string $name Name of the new group.
		 */
		return apply_filters( 'bp_get_new_group_location_city', $location_city );
	}

function bp_new_group_sport() {
	echo bp_get_new_group_sport();
}
	function bp_get_new_group_sport() {
		$bp   = buddypress();
		$sport = isset( $bp->groups->current_group->sport )
			? $bp->groups->current_group->sport
			: '';
		 ...
		 * @param string $name Name of the new group.
		 */
		return apply_filters( 'bp_get_new_group_sport', $sport );
	}
...
/**
 * Echoes the output of bp_get_current_group_location_state().
 *
 * @since 1.5.0
 */
function bp_current_group_location_state() {
	echo bp_get_current_group_location_state();
}
	/**
	 * Returns the name of the current group.
	 *
	 * @since 1.5.0
	 * @uses apply_filters() Filter bp_get_current_group_location_state to modify this output.
	 *
	 * @return string The name of the current group, if there is one.
	 */
	function bp_get_current_group_location_state() {
		$current_group      = groups_get_current_group();
		$current_group_location_state = isset( $current_group->location_state ) ? $current_group->location_state : '';

		/** This filter is documented in bp-groups/bp-groups-template.php */
		$location_state               = apply_filters( 'bp_get_group_location_state', $current_group_location_state );
		 ...
		 * @param object $current_group Instance holding the current group.
		 */
		return apply_filters( 'bp_get_current_group_location_state', $location_state, $current_group );
	}
/**
 * Echoes the output of bp_get_current_group_location_city().
 *
 * @since 1.5.0
 */
function bp_current_group_location_city() {
	echo bp_get_current_group_location_city();
}
	/**
	 * Returns the name of the current group.
	 *
	 * @since 1.5.0
	 * @uses apply_filters() Filter bp_get_current_group_location_city to modify this output.
	 *
	 * @return string The name of the current group, if there is one.
	 */
	function bp_get_current_group_location_city() {
		$current_group      = groups_get_current_group();
		$current_group_location_city = isset( $current_group->location_city ) ? $current_group->location_city : '';

		/** This filter is documented in bp-groups/bp-groups-template.php */
		$location_city               = apply_filters( 'bp_get_group_location_city', $current_group_location_city );
		 ...
		 * @param object $current_group Instance holding the current group.
		 */
		return apply_filters( 'bp_get_current_group_location_city', $location_city, $current_group );
	}

function bp_current_group_sport() {
	echo bp_get_current_group_sport();
}
	/**
	 * Returns the name of the current group.
	 *
	 ...
	 * @return string The name of the current group, if there is one.
	 */
	function bp_get_current_group_sport() {
		$current_group      = groups_get_current_group();
		$current_group_sport = isset( $current_group->sport ) ? $current_group->sport : '';

		/** This filter is documented in bp-groups/bp-groups-template.php */
		$sport               = apply_filters( 'bp_get_group_sport', $current_group_sport );
		 ...
		 * @param object $current_group Instance holding the current group.
		 */
		return apply_filters( 'bp_get_current_group_sport', $sport, $current_group );
	}
