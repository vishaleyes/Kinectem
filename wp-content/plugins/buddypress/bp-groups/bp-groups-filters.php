...
add_filter( 'bp_get_group_location_state',                'wptexturize' );
add_filter( 'bp_get_group_location_city',                'wptexturize' );
...
add_filter( 'bp_get_group_location_state',                'convert_chars' );
add_filter( 'bp_get_group_location_city',                'convert_chars' );
...
add_filter( 'bp_get_group_location_state',                    'wp_filter_kses',        1 );
add_filter( 'bp_get_group_location_city',                    'wp_filter_kses',        1 );
...
add_filter( 'bp_get_group_location_state',                'stripslashes' );
add_filter( 'bp_get_group_location_city',                'stripslashes' );
...
add_filter( 'groups_group_location_state_before_save',        'force_balance_tags' );
add_filter( 'groups_group_location_city_before_save',        'force_balance_tags' );
...
add_filter( 'groups_group_location_state_before_save',        'trim' );
add_filter( 'groups_group_location_city_before_save',        'trim' );
...
add_filter( 'bp_get_new_group_location_state',        'esc_attr'     );
add_filter( 'bp_get_new_group_location_city',        'esc_attr'     );
