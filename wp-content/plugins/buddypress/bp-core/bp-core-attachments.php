...
function bp_attachments_get_plupload_l10n() {
	...
	return apply_filters( 'bp_attachments_get_plupload_l10n', array(
			...
			//'file_exceeds_size_limit'   => __( '%s is too big in size Please upload image kb and less than 2mb in size.', 'buddypress' ),
			'file_exceeds_size_limit'   => __( '%s has exceeded the maximum size of 2MB', 'buddypress' ),
