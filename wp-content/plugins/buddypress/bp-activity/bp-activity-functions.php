...
/*function bp_activity_get_user_mentionfullname( $user_id ) {
	$mentionfullname = '';
...
function bp_activity_register_activity_actions() {
	...
	bp_activity_set_action(
		$bp->activity->id,
		'activity_update',
		__( '<span class="activity-bold">Posted a status update</span>', 'buddypress' ),
	...
	bp_activity_set_action(
		$bp->activity->id,
		'activity_comment',
		__( '<span class="activity-bold">Replied to a status update</span>', 'buddypress' ),
...
function bp_activity_format_activity_action_activity_update( $action, $activity ) {
	$action = sprintf( __( '%s <span class="activity-bold">posted an update</span>', 'buddypress' ), bp_core_get_userlink( $activity->user_id ) );
...
function bp_activity_format_activity_action_activity_comment( $action, $activity ) {
	$action = sprintf( __( '%s <span class="activity-bold">posted a new activity comment</span>', 'buddypress' ), bp_core_get_userlink( $activity->user_id ) );
...
function bp_activity_new_comment( $args = '' ) {
	...
	$r = wp_parse_args( $args, array(
		'id'          => false,
		'content'     => false,
		'user_id'     => false,//bp_loggedin_user_id(),
