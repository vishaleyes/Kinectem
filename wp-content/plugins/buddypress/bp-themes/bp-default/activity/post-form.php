...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<h5><?php if ( bp_is_group() )
			printf( __( "<span class='activity-bold'>What's new in %s, %s?</span>", 'buddypress' ), bp_get_group_name(), bp_get_user_firstname() );
		else
			printf( __( "<span class='activity-bold'>What's new, %s?</span>", 'buddypress' ), bp_get_user_firstname() );
	?></h5>
