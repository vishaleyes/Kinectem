...
function bp_groups_format_activity_action_created_group( $action, $activity ) {
	...
	$action = sprintf( __( '%1$s <span class="activity-bold">created the team<span> %2$s', 'buddypress'), $user_link, $group_link );
...
function bp_groups_format_activity_action_joined_group( $action, $activity ) {
	...
	$action = sprintf( __( '%1$s <span class="activity-bold">joined the team </span> %2$s', 'buddypress' ), $user_link, $group_link );
