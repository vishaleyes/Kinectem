...
jQuery(document).ready(function(){
    jQuery("#why-flip").click(function(){
        jQuery("#why-panel").slideToggle("slow");
    });
});
</script>
<div id="buddypress" class="kinectem-register-page">
	...
	<div id="why-flip">Why Kinectem?</div>
		<div id="why-panel"><img src="<?php echo content_url(); ?>/uploads/2016/03/Why-Kinectem-JPEG.jpg"></div>
