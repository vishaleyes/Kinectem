...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<p class="activity-greeting"><?php if ( bp_is_group() )
		printf( __( "<span class='activity-bold'>What's new in %s, %s?</span>", 'buddypress' ), bp_get_group_name(), bp_get_user_firstname( bp_get_loggedin_user_fullname() ) );
	else
		printf( __( "<span class='activity-bold'>What's new, %s?</span>", 'buddypress' ), bp_get_user_firstname( bp_get_loggedin_user_fullname() ) );
	?></p>
