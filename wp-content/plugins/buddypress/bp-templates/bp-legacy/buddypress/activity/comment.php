...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	...
	<div class="acomment-meta">
		...
		printf( __( '<a href="%1$s">%2$s</a><span class="activity-bold"> replied<span> <a href="%3$s" class="activity-time-since"><span class="time-since">%4$s</span></a>', 'buddypress' ), bp_get_activity_comment_user_link(), bp_get_activity_comment_name(), bp_get_activity_comment_permalink(), bp_get_activity_comment_date_recorded() );
		?>
	</div>
