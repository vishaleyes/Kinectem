		...
		<div class="item-body" id="group-create-body">
			...
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<div>
					...
					<option selected="selected" value="<?php bp_new_group_sport(); ?>"><?php bp_new_group_sport(); ?></option>
				...
				<div>
					...
					<input type="text" name="group-location-state" id="group-location-state" aria-required="true" value="<?php bp_new_group_location_state(); ?>" placeholder="State"/>
					<input type="text" name="group-location-city" id="group-location-city" aria-required="true" value="<?php bp_new_group_location_city(); ?>" placeholder="City" />
				</div>
			...
			<?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
				...
				<div class="radio">
					...
					<ul id="private-group-description">
						...
						<li><?php _e( 'This group will be listed in the teams directory and in search results.', 'buddypress' ); ?></li>
					...
					<ul id="hidden-group-description">
						...
						<li><?php _e( 'This group will not be listed in the teams directory or search results.', 'buddypress' ); ?></li>
						<li><?php _e( 'Team content and activity will only be visible to members of the group.', 'buddypress' ); ?></li>
					</ul>
				...
				<?php if ( bp_is_active( 'forums' ) ) : ?>
					...
					<h4><?php _e( 'Team Forums', 'buddypress' ); ?></h4>
					...
					<?php elseif ( is_super_admin() ) : ?>
						...
						<p><?php printf( __( '<strong>Attention Site Admin:</strong> Team forums require the <a href="%s">correct setup and configuration</a> of a bbPress installation.', 'buddypress' ), bp_core_do_network_admin() ? network_admin_url( 'settings.php?page=bb-forums-setup' ) :  admin_url( 'admin.php?page=bb-forums-setup' ) ); ?></p>
			...
			<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
				...
				<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<h4><?php _e( 'Crop Team Profile Photo', 'buddypress' ); ?></h4>
			...
			<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
				...
				<div class="submit" id="previous-next">
					...
					<?php if ( bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Create Team and Continue', 'buddypress' ); ?>" id="group-creation-create" name="save" />
