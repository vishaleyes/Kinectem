...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<?php //if ( bp_is_group() )		printf( __( "What's new in %s, %s?", 'buddypress' ), bp_get_group_name(), bp_get_user_firstname( bp_get_loggedin_user_fullname() ) );
	//else
	...
	<!--<div id="whats-new-content">
		<div id="whats-new-textarea">-->
			...
			?></label>-->
            <div class="post_text">
			<textarea class="white_bg" name="whats-new" id="whats-new"
				<?php if ( bp_is_group() ) : ?>data-suggestions-group-id="<?php echo esc_attr( (int) bp_get_current_group_id() ); ?>" <?php endif; ?>
			><?php if ( isset( $_GET['r'] ) ) : ?>@<?php echo esc_textarea( $_GET['r'] ); ?> <?php endif; ?><?php _e( 'What’s new ?', 'buddypress' );?></textarea>
		</div>
<!--<div class="post_form_ftr">
									<div class="col-md-6 atch_file">
