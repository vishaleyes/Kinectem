...
<div id="buddypress">
    ...
    <div class="col-xs-12 cntnt_hdr">
		<ul class="white_bg">
			...
			<li id="activity-filter-select" class="last butn_post">
            <img src="http://clients.creativepeers.com/kinectem/wp-content/themes/kinectem/images/evry.png" alt="every">
				<!--<label for="activity-filter-by"><?php ///_e( 'Show:', 'buddypress' ); ?></label>-->
				<select id="activity-filter-by">
					<option value="-1"><?php _e( 'Everything', 'buddypress' ); ?> <i class="fa fa-angle-down" aria-hidden="true"></i><?php //_e( '&mdash; Everything &mdash;', 'buddypress' ); ?></option>
