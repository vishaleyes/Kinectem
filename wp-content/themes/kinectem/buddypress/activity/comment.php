...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	...
	<div class="acomment-options">
		...
		<?php if ( bp_activity_user_can_delete() ) : ?>
			...
			<span><a href="<?php bp_activity_comment_delete_link(); ?>" class="delete acomment-delete confirm bp-secondary-action" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/delt_img.png" alt="delt_img" width="23" height="23"></a></span>
